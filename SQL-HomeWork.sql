...
форматирует их в кол-во дней часов.
...
-- Блок высчитывающий секунды и минуты
    WHILE count < 2 DO 
        SET sec = num % 60;
        SET count = count + 1;
...
-- Цикл вычисляющий чётные числа
    WHILE  count < 10 DO
        SET count = count + 2;

	    -- Различные виды склеивания строк для пере-
	    -- численных чисел и последнего числа
        IF count < 10 THEN
